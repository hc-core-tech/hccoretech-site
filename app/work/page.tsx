...
const STUDIES: Study[] = [
  {
    ...
    status: 'live',
    summary: 'Full brand system, two websites, and founding CoreDesk workspace for a trauma-informed care practice serving families rebuilding after the Dutch toeslagenaffaire.',
  ...
  },
  {
    ...
    year: '2025 to present',
    status: 'in-build',
    summary: 'Two-site build for a values-led children\'s education programme and its founder\'s author companion. Forest and sunlight-gold brand system, no AI imagery.',
  ...
  },
  {
    ...
    year: 'Q1 to Q2 2026',
    status: 'shipped',
    summary: 'Led AI development on a nine-agent content production platform for enterprise clients. Full pipeline from ideation through publish, with human-in-the-loop review layers. Delivered on time. Client details under NDA.',
      ...
      <section style={{ padding: '80px 32px 64px', maxWidth: '1080px', margin: '0 auto' }}>
        ...
        <Reveal delay={100}>
          <h1 style={{
            ...
            <span style={{ fontStyle: 'italic', color: T.gold, fontWeight: 500 }}>
              Every deliverable from one hand.
            </span>
          </h1>
        </Reveal>
        ...
        <Reveal delay={200}>
          <p style={{
            ...
            A small book of client work, deep case studies where I can share them,
            and honest anonymised summaries where NDAs apply. Every engagement was
            scoped, priced, and delivered by me directly.
          </p>
        </Reveal>
      </section>
        ...
        <Reveal>
          <div style={{ maxWidth: '760px', margin: '0 auto', textAlign: 'center' }}>
            ...
            <p style={{
              ...
              Send a brief through the form or book a discovery call. I respond within 48 hours.
            </p>
